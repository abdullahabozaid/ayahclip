...
| Ayah recognition re-review | Safety-first candidate matcher, ambiguity alternatives, Basmala recovery, pause-bounded review candidates for transcripts contaminated by spoken intros/outros, no Quran text generated by ASR, explicit range confirmation, truthful Prepare/Listen/Match/Align status, and 73-case real-audio recognition matrix; recovered windows can never auto-apply a range | Implemented; broader handset corpus still required |
