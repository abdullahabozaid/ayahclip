...
| Native iOS beta | Implemented, distribution signing pending | 26 unit and 8 UI tests pass, including maximum Dynamic Type, debounced draft autosave/background flush, and bounded Undo/Redo across project, timing, style, layout, and media edits; arm64 Release archive contains the Share extension, privacy manifests, app icon, Quran font, and dSYMs |
