...
- **Completed and continuing expansion:** English/Arabic reciter search matches names, place and style; a word-synchronised capability filter, persistent local favourites, and a de-duplicated five-voice recent group keep the 79-recording catalog scannable without introducing accounts or server tracking.
