...
AyahClip now exposes 101 verified recitation recordings: 46 distinct Hafs voices/styles from EveryAyah and 55 complete timed Hafs recordings from MP3Quran. The remaining EveryAyah folders are lower-bitrate duplicates, translations, Warsh recordings, support files, or alternate folder spellings.
...
The admitted MP3Quran reads are Abdelbari Al-Toubayti (49), Abdullah Al-Buaijan (58), Abdullah Khayyat (61), Abdulwadood Haneef (71), Emad Zuhair Hafez (78), Khalid Al-Mohana (159), Bandar Balilah (217), Raad Al-Kurdi (221), Muhammad Khalil Al-Qari (229), Mansour Al-Salimi (245), Ahmad Al-Nufais (259), Peshawa Qadr Al-Kurdi (268), Abdulaziz Al-Turki (282), Anas Al-Emadi (314), Idrees Abkr (12), Khalid Al-Jileel (20), Ahmad Al-Hawashi (6), Abdul Aziz Al-Ahmad (55), Abdullah Al-Mousa (243), Abdulrahman Al-Oosi (225), Haitham Al-Dokhin (273), Tawfeeq As-Sayegh (17), Abdulrasheed Soufi (258), Muhammad Burhaji (340), Abdullah Al-Khalaf (244), Khalid Abdulkafi (22), Majed Al-Zamil (139), Saleh Alshamrani (300), Hassan Aldaghriri (10905), Alzain Mohammad Ahmad (13), Ahmad Deban (265), Sayed Ahmad Hashemi (294), Wadeea Al-Yamani (219), Ibrahim Al-Asiri (3), Ahmad Saber (8), Dawood Hamza (25), Zaki Daghistani (33), Shirazad Taher (38), Saber Abdulhakm (39), Saleh Alsahood (40), Saleh Al-Habdan (42), Salah Alhashim (44), Adel Ryyan (48), Abdulbari Mohammad (50), Abdulmohsin Al-Harthy (66), Abdulhadi Kanakeri (70), Neamah Al-Hassan (88), Yousef Bin Noah Ahmad (193), Ahmed Al-Trabulsi (201), Ahmed Amer (203), Abdulrahman Al-Majed (236), Mohammad Albukheet (250), Khalid Mohammadi (295), Issa Omar Sanankoua (303), and Mohammad Saleh Alim Shah (110). Each has 114 advertised Surahs, 114 official timing files, complete representative cue coverage, CORS, byte ranges, attribution, and a real browser MP4 fixture.

The 2026-07-18 expansion gate rejected Ibrahim Al-Dosari (232), Ahmad Issa Al-Maasarawi (289), Ahmad Shaheen (256), Abdulaziz Az-Zahrani (56), Jamaan Alosaimi (181), and Mohammad Rashad Alshareef (198) because their exact browser MP4s were materially shorter than the official 114:6 cues. Hasan Saleh (299), Abdulwali Al-Arkani (72), and Abdulmohsin Al-Obaikan (69) also remain unadmitted because representative official cues were implausibly short and require manual semantic review. A successful HTTP response is not sufficient evidence for Quranically complete playback.
...
Decision: **production-admitted for the 55 audited reads above**. Other MP3Quran reads remain candidates until they independently pass the same catalog, cue, CORS, range, browser-preview, and MP4-duration gates.
...
6. **Completed:** 55 timed reads are admitted, including additional Haramain-linked voices, and the searchable, keyboard-complete catalog supports region, recitation style, word-synchronised capability, favourites, and recent voices.

### Verification checkpoint

On 2026-07-18, `npm run check:reciter-sources -- --output <report.json>` tested four references for every catalog entry: 1:1, 2:255, 55:13, and 114:6. The expanded catalog is required to pass 404/404 live source probes plus the 54-read browser MP4 matrix and Mansour Al-Salimi's dedicated export journey before publication.
