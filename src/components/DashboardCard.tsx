...
export function DashboardCard({
  ...
  return (
    <article
      className={`card-lift panel group relative overflow-hidden p-2.5 ${
    ...
    >
      ...
      {!selectable && (
        <button
          ...
          className="absolute right-3 top-3 flex h-11 w-11 items-center justify-center rounded-full bg-[var(--ink-deep)]/80 text-[var(--muted)] opacity-100 backdrop-blur-sm transition-all hover:text-red-400 sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-within:opacity-100"
        >
