...
export const reciters: Reciter[] = [
  { id: "abdelbari-toubayti", name: "Abdelbari Al-Toubayti", arabicName: "عبدالبارئ الثبيتي", audioSource: mp3QuranChapter(49, "https://server6.mp3quran.net/thubti/"), region: "haramain", style: "Murattal" },
  { id: "abdullah-khayyat", name: "Abdullah Khayyat", arabicName: "عبدالله خياط", audioSource: mp3QuranChapter(61, "https://server12.mp3quran.net/kyat/"), region: "haramain", style: "Murattal" },
  ...
  { id: "abdulwadood-haneef", name: "Abdulwadood Haneef", arabicName: "عبدالودود حنيف", audioSource: mp3QuranChapter(71, "https://server8.mp3quran.net/wdod/"), region: "haramain", style: "Murattal" },
  ...
  { id: "mohammad-khalil-al-qari", name: "Muhammad Khalil Al-Qari", arabicName: "محمد خليل القارئ", audioSource: mp3QuranChapter(229, "https://server8.mp3quran.net/m_qari/"), region: "haramain", style: "Murattal" },
  ...
  { id: "emad-hafez", name: "Emad Zuhair Hafez", arabicName: "عماد زهير حافظ", audioSource: mp3QuranChapter(78, "https://server6.mp3quran.net/hafz/"), region: "haramain", style: "Murattal" },
  { id: "khalid-almohana", name: "Khalid Al-Mohana", arabicName: "خالد المهنا", audioSource: mp3QuranChapter(159, "https://server11.mp3quran.net/mohna/"), region: "haramain", style: "Murattal" },
  ...
  { id: "ahmad-saber", name: "Ahmad Saber", arabicName: "أحمد صابر", audioSource: mp3QuranChapter(8, "https://server8.mp3quran.net/saber/"), region: "egypt", style: "Murattal" },
  { id: "saber-abdulhakm", name: "Saber Abdulhakm", arabicName: "صابر عبدالحكم", audioSource: mp3QuranChapter(39, "https://server12.mp3quran.net/hkm/"), region: "egypt", style: "Murattal" },
  { id: "ahmed-amer", name: "Ahmed Amer", arabicName: "أحمد عامر", audioSource: mp3QuranChapter(203, "https://server10.mp3quran.net/Aamer/"), region: "egypt", style: "Murattal" },
  ...
  { id: "abdulaziz-al-ahmad", name: "Abdul Aziz Al-Ahmad", arabicName: "عبدالعزيز الأحمد", audioSource: mp3QuranChapter(55, "https://server11.mp3quran.net/a_ahmed/"), region: "gulf", style: "Murattal" },
  { id: "abdullah-al-mousa", name: "Abdullah Al-Mousa", arabicName: "عبدالله الموسى", audioSource: mp3QuranChapter(243, "https://server14.mp3quran.net/mousa/Rewayat-Hafs-A-n-Assem/"), region: "gulf", style: "Murattal" },
  { id: "abdulrahman-al-oosi", name: "Abdulrahman Al-Oosi", arabicName: "عبدالرحمن العوسي", audioSource: mp3QuranChapter(225, "https://server6.mp3quran.net/aloosi/"), region: "gulf", style: "Murattal" },
  { id: "fares-abbad", name: "Fares Abbad", arabicName: "فارس عباد", audioSource: everyAyah("Fares_Abbad_64kbps"), region: "gulf", style: "Murattal" },
  { id: "haitham-al-dokhin", name: "Haitham Al-Dokhin", arabicName: "هيثم الدخين", audioSource: mp3QuranChapter(273, "https://server16.mp3quran.net/h_dukhain/Rewayat-Hafs-A-n-Assem/"), region: "gulf", style: "Murattal" },
  ...
  { id: "ibrahim-al-asiri", name: "Ibrahim Al-Asiri", arabicName: "إبراهيم العسيري", audioSource: mp3QuranChapter(3, "https://server6.mp3quran.net/3siri/"), region: "gulf", style: "Murattal" },
  { id: "dawood-hamza", name: "Dawood Hamza", arabicName: "داود حمزة", audioSource: mp3QuranChapter(25, "https://server9.mp3quran.net/hamza/"), region: "gulf", style: "Murattal" },
  { id: "saleh-alsahood", name: "Saleh Alsahood", arabicName: "صالح الصاهود", audioSource: mp3QuranChapter(40, "https://server8.mp3quran.net/sahood/"), region: "gulf", style: "Murattal" },
  { id: "saleh-al-habdan", name: "Saleh Al-Habdan", arabicName: "صالح الهبدان", audioSource: mp3QuranChapter(42, "https://server6.mp3quran.net/habdan/"), region: "gulf", style: "Murattal" },
  { id: "salah-alhashim", name: "Salah Alhashim", arabicName: "صلاح الهاشم", audioSource: mp3QuranChapter(44, "https://server12.mp3quran.net/salah_hashim_m/"), region: "gulf", style: "Murattal" },
  { id: "adel-ryyan", name: "Adel Ryyan", arabicName: "عادل ريان", audioSource: mp3QuranChapter(48, "https://server8.mp3quran.net/ryan/"), region: "gulf", style: "Murattal" },
  { id: "abdulmohsin-al-harthy", name: "Abdulmohsin Al-Harthy", arabicName: "عبدالمحسن الحارثي", audioSource: mp3QuranChapter(66, "https://server6.mp3quran.net/mohsin_harthi/"), region: "gulf", style: "Murattal" },
  { id: "abdulrahman-al-majed", name: "Abdulrahman Al-Majed", arabicName: "عبدالرحمن الماجد", audioSource: mp3QuranChapter(236, "https://server10.mp3quran.net/a_majed/"), region: "gulf", style: "Murattal" },
  { id: "mohammad-albukheet", name: "Mohammad Albukheet", arabicName: "محمد البخيت", audioSource: mp3QuranChapter(250, "https://server14.mp3quran.net/bukheet/"), region: "gulf", style: "Murattal" },
  ...
  { id: "zaki-daghistani", name: "Zaki Daghistani", arabicName: "زكي داغستاني", audioSource: mp3QuranChapter(33, "https://server9.mp3quran.net/zaki/"), region: "levant", style: "Murattal" },
  { id: "abdulhadi-kanakeri", name: "Abdulhadi Kanakeri", arabicName: "عبدالهادي أحمد كناكري", audioSource: mp3QuranChapter(70, "https://server6.mp3quran.net/kanakeri/"), region: "levant", style: "Murattal" },
  { id: "neamah-al-hassan", name: "Neamah Al-Hassan", arabicName: "نعمة الحسان", audioSource: mp3QuranChapter(88, "https://server8.mp3quran.net/namh/"), region: "levant", style: "Murattal" },
  { id: "ahmed-al-trabulsi", name: "Ahmed Al-Trabulsi", arabicName: "أحمد الطرابلسي", audioSource: mp3QuranChapter(201, "https://server10.mp3quran.net/trabulsi/"), region: "levant", style: "Murattal" },
  ...
  { id: "shirazad-taher", name: "Shirazad Taher", arabicName: "شيرزاد عبدالرحمن طاهر", audioSource: mp3QuranChapter(38, "https://server12.mp3quran.net/taher/"), region: "international", style: "Murattal" },
  { id: "abdulbari-mohammad", name: "Abdulbari Mohammad", arabicName: "عبدالبارئ محمد", audioSource: mp3QuranChapter(50, "https://server12.mp3quran.net/bari/"), region: "international", style: "Murattal" },
  { id: "yousef-bin-noah-ahmad", name: "Yousef Bin Noah Ahmad", arabicName: "يوسف بن نوح أحمد", audioSource: mp3QuranChapter(193, "https://server8.mp3quran.net/noah/"), region: "international", style: "Murattal" },
  { id: "khalid-mohammadi", name: "Khalid Mohammadi", arabicName: "خالد كريم محمدي", audioSource: mp3QuranChapter(295, "https://server16.mp3quran.net/kh_mohammadi/Rewayat-Hafs-A-n-Assem/"), region: "international", style: "Murattal" },
  { id: "issa-omar-sanankoua", name: "Issa Omar Sanankoua", arabicName: "عيسى عمر سناكو", audioSource: mp3QuranChapter(303, "https://server16.mp3quran.net/i_sanankoua/Rewayat-Hafs-A-n-Assem/"), region: "international", style: "Murattal" },
  { id: "mohammad-saleh-alim-shah", name: "Mohammad Saleh Alim Shah", arabicName: "محمد صالح عالم شاه", audioSource: mp3QuranChapter(110, "https://server12.mp3quran.net/shah/"), region: "international", style: "Murattal" },
